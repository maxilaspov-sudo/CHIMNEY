...
const ALL_REVIEWS = [
  ...
  { name: "James K.", city: "San Diego", rating: 5, date: "December 2024", service: "Chimney Sweep", text: "Best price I found after calling four companies, and the quality was better too. The technician was a true professional — explained everything thoroughly, no upsell pressure. The fireplace drafts perfectly now." },
